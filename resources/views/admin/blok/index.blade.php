        ...
        @csrf
          <div class="modal-body">
            <div class="form-group">
              <label for="nama">Nama Blok</label>@error('nama') <span class="text-danger">{{ $message }}</span> @enderror
              <input type="text" required name="nama" class="form-control @error('nama') is-invalid @enderror" id="menu" placeholder="Masukan Nama blok">
            </div>
...
<div class="modal fade" id="modal-hapus{{$data->id}}">
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-danger">
      ...
      <form action="{{ route('blok.destroy', $data->id) }}" method="post" class="d-inline" id="id_form">
        @method('delete')
        @csrf
          <div class="modal-body">
...
<div class="modal fade" id="modal-edit{{$data->id}}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('blok.update', $data->id) }}" method="POST">
      @method('PATCH')
      @csrf
        <div class="modal-body">
          <div class="form-group">
            <label for="nama">Nama blok</label>@error('nama') <span class="text-danger">{{ $message }}</span> @enderror
            <input type="text" required name="nama" class="form-control @error('nama') is-invalid @enderror" id="menu" value="{{ $data->blok_nama }}">
          </div>

          <div class="form-group">
            <label for="ket">Keterangan</label>@error('ket') <span class="text-danger">{{ $message }}</span> @enderror
            <input type="text" name="ket" class="form-control @error('ket') is-invalid @enderror" id="menu" value="{{ $data->blok_ket }}">
          </div>
        </div>
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
